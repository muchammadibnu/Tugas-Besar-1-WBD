...
<head>
    ...
    <title>Chocolate Stock Page</title>
    <link rel='stylesheet' type='text/css' media='screen' href='css/ChocolateStockPage.css'>
</head>
<body>
    <header>
        <nav>
    ...
    <div class="BuyNow">
        <a href="ChocolateAddStockPage.php?chocoID=<?php echo $_GET["chocoID"];?>">Add Stock</a>
    </div>
</body>
</html>